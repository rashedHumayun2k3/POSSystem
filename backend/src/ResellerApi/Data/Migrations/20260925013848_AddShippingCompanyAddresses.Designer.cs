...
namespace ResellerApi.Data.Migrations
{
    ...
    [Migration("20260925013848_AddShippingCompanyAddresses")]
    partial class AddShippingCompanyAddresses
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ResellerApi.Entities.MarketplaceDetailTemplateLabel", b =>
                {
                    ...
                    b.Property<string>("ValuePlaceholder")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.HasKey("Id");

                    b.HasIndex("CategoryId", "Section", "Label")
                        .IsUnique();
            ...
            modelBuilder.Entity("ResellerApi.Entities.Product", b =>
                {
                    ...
                    b.ToTable("products", null, t =>
                        {
                            t.HasCheckConstraint("CK_products_ImageSource", "[ImageSource] IN ('COMMON', 'INDIVIDUAL')");
                        });
                });
            ...
            modelBuilder.Entity("ResellerApi.Entities.PurchaseShipment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<Guid>("PurchaseTripCostId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<decimal>("RateAmountSnapshot")
                        .HasColumnType("DECIMAL(14,2)");
                    ...
                    b.Property<string>("ShippingCompanyNameSnapshot")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<Guid?>("ShippingCompanyRateId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PurchaseTripCostId");

                    b.HasIndex("ShippingCompanyId");

                    b.HasIndex("ShippingCompanyRateId");

                    b.HasIndex("TripId")
                        .IsUnique()
                        .HasFilter("[DeletedAt] IS NULL");

                    b.ToTable("purchase_shipments", (string)null);
                });
            ...
            modelBuilder.Entity("ResellerApi.Entities.ShippingCompany", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<string>("ChinaAddress")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
            ...
            modelBuilder.Entity("ResellerApi.Entities.ShippingCompanyRate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.HasIndex("ShippingCompanyId", "ShippingMethod", "ChargeBasis")
                        .IsUnique()
                        .HasFilter("[DeletedAt] IS NULL");

                    b.ToTable("shipping_company_rates", (string)null);
                });
            ...
            modelBuilder.Entity("ResellerApi.Entities.SuggestedProduct", b =>
                {
                    ...
                    b.ToTable("suggested_products", null, t =>
                        {
                            t.HasCheckConstraint("CK_suggested_products_ImageSource", "[ImageSource] IN ('COMMON', 'INDIVIDUAL')");
                        });
                });
            ...
            modelBuilder.Entity("ResellerApi.Entities.Product", b =>
                {
                    ...
                    b.HasOne("ResellerApi.Entities.SuggestedProduct", "SuggestedProduct")
            ...
            modelBuilder.Entity("ResellerApi.Entities.PurchaseShipment", b =>
                {
                    b.HasOne("ResellerApi.Entities.PurchaseTripCost", "PurchaseTripCost")
                        .WithMany()
                        .HasForeignKey("PurchaseTripCostId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("ResellerApi.Entities.ShippingCompany", "ShippingCompany")
                        .WithMany()
                        .HasForeignKey("ShippingCompanyId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ResellerApi.Entities.ShippingCompanyRate", "ShippingCompanyRate")
                        .WithMany()
                        .HasForeignKey("ShippingCompanyRateId")
                        .OnDelete(DeleteBehavior.NoAction);
                    ...
                    b.Navigation("PurchaseTripCost");

                    b.Navigation("ShippingCompany");

                    b.Navigation("ShippingCompanyRate");
