...
public interface IOrderService
{
    ...
    Task<List<OrderListDto>> ListAsync(string? orderStatus, string? fulfillmentStatus, string? channel, string? q, DateTime? from, DateTime? to);
    Task<List<OrderListDto>> ListByProductAsync(Guid productId);
