...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  const titleMap: Record<string, string> = {
    ...
    "/more/reports/inventory":   t("reports.menu.inventory"),
    "/more/reports/financial":   t("reports.menu.financial"),
    "/more/reports/orders":      t("reports.menu.orders"),
    "/more/reports/stock-valuation": t("reports.menu.stockValuation"),
